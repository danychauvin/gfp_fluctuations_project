...
def submit_preprocessing(experimentFolderPath,preprocFolder,template,NORMALIZATION_REGION_OFFSET):    
...
def create_yaml_file(batch_file,experimentFolderPath,preprocFolder,batch_folder,subset):
    preproc_dir="%s/%s"%(experimentFolderPath,preprocFolder)
    print(preproc_dir)
