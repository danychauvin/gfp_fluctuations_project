...
plot_box_condition <- function(.cond){
  ...
  toplot %>% 
    ...
    boxPlotXY(.,lambda,l_q,10)+ggpubr::stat_cor(method = "pearson",size=3)+
  ...
  ggsave(sprintf("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/fig2/l_q_vs_lambda_box_%s.pdf",.cond),width=24,height=16)
}
