...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/figures/pdfs/mean_tot_GFP_vs_mean_growth_rate_med2_only.pdf",width=6,height=4)