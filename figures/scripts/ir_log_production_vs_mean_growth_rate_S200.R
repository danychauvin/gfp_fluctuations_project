...
data_toplot %>% 
  ...
  ggplot()+
  geom_point(aes(mean_gr,ir,col=date),alpha=0.5)+
...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/fig2/ir_log_production_vs_mean_growth_rate_S200.pdf",width=6,height=4)