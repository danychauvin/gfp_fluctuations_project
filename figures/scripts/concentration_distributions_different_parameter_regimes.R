...
for(d in datatypes){
  ...
  ggsave(sprintf("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/figures/concentration_distributions_different_parameter_regimes_%s.pdf",d),width=40,height=30,units="cm",limitsize = FALSE)
}
