...
data_toplot %>% 
  ...
  ggplot()+
  geom_point(aes(mean_x,ir),alpha=0.5)+
...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/fig2/interquartile_log_c_vs_mean_log_c_Fpromoters_S200_Cdate.pdf",width=6,height=4)