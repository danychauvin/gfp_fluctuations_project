...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/figures/pdfs/CV_tot_GFP_vs_mean_growth_rate.pdf",width=6,height=4)