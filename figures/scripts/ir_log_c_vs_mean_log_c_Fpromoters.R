...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/fig2/interquartile_log_c_vs_mean_log_c.pdf",width=6,height=4)