...
data_toplot <- experimental_data %>% 
  ...
  mutate(sd_x=sqrt(abs(cov_gg/(gfp_nb)**2))) %>% 
...
ggsave("/scicore/home/nimwegen/rocasu25/Documents/Projects/biozentrum/gfp_fluctuations_project/figures/pdfs/mean_log_tot_GFP_vs_mean_growth_rate.pdf",width=6,height=4)