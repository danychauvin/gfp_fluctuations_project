...
path_to_MM_data_summary <- "./datalist_hi1_glucose020.csv"
...
## -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
unique(myframes_complete_goodcells %>% 
  distinct(cell,.keep_all=TRUE) %>% 
  ungroup() %>% 
...
#ggsave("./hi1_glucose2_growth_rate_vs_time_all_gl.pdf",width=20,height=50,limitsize=FALSE)
...
ggsave("./cell_detection_offset_glucose020.pdf",height=20,width=20)
...
ggsave("./length_time_glucose020.pdf",height=20,width=20)
