...
path_to_MM_data_summary <- "./datalist_hi1_acetate005.csv"
...
# Filtering out cells with unreasonable length traces

cells_discarded_manually <- c("1.9.19","2.8.21","2.20.4","0.18.2","1.9.5","2.8.15")
#cells_discarded_manually <- c("no_bad_cell")
...
#ggsave("./hi1_acetate_005_growth_rate_vs_time_all_gl.pdf",width=20,height=50,limitsize=FALSE)
...
ggsave("./cell_detection_offset_acetate005.pdf",height=20,width=20)
