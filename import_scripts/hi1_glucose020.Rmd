...
In this data-set, growth lanes are of unequal length. Growth lanes characterized by a number above 30 are long. Ones characterized by a number below 30 are short. In what is next, we only analyze data obtained with shorter growth lanes.
